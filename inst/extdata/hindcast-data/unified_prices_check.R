# Jul 12 2022 - usa hybrid linear adaptive results different, verify that it's due to the small
# changes in prices from using the updated data from gcamdata.
# do it here by dropping that update, rebuild the package, redo the gcamland runs
# and compare to the gmd paper.
library(dplyr)
library(tidyr)
library(ggplot2)
